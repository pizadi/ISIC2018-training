...
class UNetPP(nn.Module):
    def __init__(self, learning_rate=None,  loss_fn=None, optimizer=None, device=None):
        ...
        self.b0_0 = self.convblock(self.scale)
        self.b0_1 = self.convblock(self.scale)
        self.up0_1 = nn.ConvTranspose2d(self.scale, self.scale, 2, stride=(2, 2))
        self.b0_2 = self.convblock(self.scale)
        self.up0_2 = nn.ConvTranspose2d(self.scale, self.scale, 2, stride=(2, 2))
        self.b0_3 = self.convblock(self.scale)
        self.up0_3 = nn.ConvTranspose2d(self.scale, self.scale, 2, stride=(2, 2))
        self.b0_4 = self.convblock(self.scale)
        self.up0_4 = nn.ConvTranspose2d(self.scale, self.scale, 2, stride=(2, 2))

        self.b1_0 = self.convblock(self.scale * 2)
        self.b1_1 = self.convblock(self.scale * 2)
        self.up1_1 = nn.ConvTranspose2d(self.scale * 2, self.scale * 2, 2, stride=(2, 2))
        self.b1_2 = self.convblock(self.scale * 2)
        self.up1_2 = nn.ConvTranspose2d(self.scale * 2, self.scale * 2, 2, stride=(2, 2))
        self.b1_3 = self.convblock(self.scale * 2)
        self.up1_3 = nn.ConvTranspose2d(self.scale * 2, self.scale * 2, 2, stride=(2, 2))

        self.b2_0 = self.convblock(self.scale * 5)
        self.b2_1 = self.convblock(self.scale * 5)
        self.up2_1 = nn.ConvTranspose2d(self.scale * 5, self.scale * 5, 2, stride=(2, 2))
        self.b2_2 = self.convblock(self.scale * 5)
        self.up2_2 = nn.ConvTranspose2d(self.scale * 5, self.scale * 5, 2, stride=(2, 2))

        self.b3_0 = self.convblock(self.scale * 13)
        self.b3_1 = self.convblock(self.scale * 13)
        self.up3_1 = nn.ConvTranspose2d(self.scale * 13, self.scale * 13, 2, stride=(2, 2))

        self.b4_0 = self.convblock(self.scale * 34)

        self.out1 = nn.Conv2d(self.scale*2, 1, (1, 1))
        self.out2 = nn.Conv2d(self.scale*5, 1, (1, 1))
        self.out3 = nn.Conv2d(self.scale*13, 1, (1, 1))
        self.out4 = nn.Conv2d(self.scale*34, 1, (1, 1))
    ...
    def forward(self, X):
        ...
        x0_0 = self.b0_0(X)
        x0_1 = self.b0_1(F.max_pool2d(x0_0, (2, 2), (2, 2)))
        x0_2 = self.b0_2(F.max_pool2d(x0_1, (2, 2), (2, 2)))
        x0_3 = self.b0_3(F.max_pool2d(x0_2, (2, 2), (2, 2)))
        x0_4 = self.b0_4(F.max_pool2d(x0_3, (2, 2), (2, 2)))
        ...
        y1 = torch.sigmoid(self.out1(x1_0))
        y2 = torch.sigmoid(self.out2(x2_0))
        y3 = torch.sigmoid(self.out3(x3_0))
        y4 = torch.sigmoid(self.out4(x4_0))
